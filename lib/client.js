...
var Client = function(options) {
  ...
  this.peerPool    = new PeerPool("Client total", null, 100, 10);
  this.peerPool_ul = new PeerPool("Client upload", this.peerPool, 10, 5);
  this.peerPool_dl = new PeerPool("Client download", this.peerPool, 10, 5);
